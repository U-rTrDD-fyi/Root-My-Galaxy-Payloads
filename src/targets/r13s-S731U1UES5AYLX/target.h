...
#define BUILD_VARIANT_LABEL "r13s-S731U1UES5AYLX-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "r13s-S731U1UES5AYLX-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/r13sue/r13s:16/BP2A.250605.031.A3/S731U1UES5AYLX_OYM5AYLX:user/release-keys"
#endif
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000db420ULL
...
#define PSELECT_ENTER_DELAY_USEC 70000
...
#define P0_FINGERPRINT_HEADER \
  "targets/r13s-S731U1UES5AYLX/p0_fingerprint.h"
#endif
...
#define ASHMEM_MISC_FOPS_OFF 0x02399030ULL
#define ASHMEM_FOPS_OFF 0x013567f0ULL
#define ASHMEM_IOCTL_OFF 0x00cd8330ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00cd8c68ULL
#define ASHMEM_MMAP_OFF 0x00cd8cc0ULL
#define ASHMEM_OPEN_OFF 0x00cd8eecULL
#define ASHMEM_RELEASE_OFF 0x00cd8f74ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00cd9094ULL
#define CONFIGFS_READ_ITER_OFF 0x0046f5f8ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0046fb28ULL
#define COPY_SPLICE_READ_OFF 0x003ee1b0ULL
#define NOOP_LLSEEK_OFF 0x003a0668ULL
#define INIT_TASK_OFF 0x0221f800ULL
#define ROOT_TASK_GROUP_OFF 0x02425cc0ULL
#define SELINUX_ENFORCING_OFF 0x024fa328ULL
#define KMALLOC_CACHES_OFF 0x016fc9d8ULL
#define ANON_PIPE_BUF_OPS_OFF 0x011aa150ULL
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d3a70ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0220ae58ULL
...
#define SLIDE_NFULNL_LOGGER_OFF 0x01643502ULL
#define SLIDE_LOGGERS_0_1_OFF 0x02212a08ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF 0x023537b8ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x0259c4a0ULL
