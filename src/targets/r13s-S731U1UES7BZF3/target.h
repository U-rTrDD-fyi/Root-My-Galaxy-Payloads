...
#define BUILD_VARIANT_LABEL \
  "r13s-S731U1UES7BZF3-app-production-slide8-fops8"
...
#else
#define BUILD_VARIANT_LABEL "r13s-S731U1UES7BZF3-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/r13sue/r13s:16/BP4A.251205.006/S731U1UES7BZF3_OYM7BZF3:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/r13s-S731U1UES7BZF3/p0_fingerprint.h"
#endif
...
#define ASHMEM_IOCTL_OFF 0x00d3a19cULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d3aad4ULL
#define ASHMEM_MMAP_OFF 0x00d3ab2cULL
#define ASHMEM_OPEN_OFF 0x00d3ad58ULL
#define ASHMEM_RELEASE_OFF 0x00d3ade0ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00d3af00ULL
#define ANON_PIPE_BUF_OPS_OFF 0x0121ced0ULL
#define ASHMEM_FOPS_OFF 0x013d90c8ULL
#define KMALLOC_CACHES_OFF 0x017a7a58ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x022eae58ULL
#define INIT_TASK_OFF 0x022ff840ULL
#define ROOT_TASK_GROUP_OFF 0x02515cc0ULL
#define SELINUX_ENFORCING_OFF 0x025ea478ULL
#define SYSCTL_BOOTID_OFF 0x026cd5e0ULL
#define ASHMEM_MISC_OFF 0x02484c20ULL
#define ASHMEM_MUTEX_OFF 0x02484b80ULL
#define ASHMEM_SHRINKER_OFF 0x02484bb0ULL
#define ASHMEM_SHRINK_WAIT_OFF 0x02484bf0ULL
#define ASHMEM_LRU_LIST_OFF 0x02484c10ULL

#define ASHMEM_MISC_FOPS_OFF (ASHMEM_MISC_OFF + 0x10ULL)
#define ASHMEM_MISC_FOPS (KIMAGE_TEXT_BASE + ASHMEM_MISC_FOPS_OFF)
#define ASHMEM_MUTEX (KIMAGE_TEXT_BASE + ASHMEM_MUTEX_OFF)
#define ASHMEM_SHRINKER (KIMAGE_TEXT_BASE + ASHMEM_SHRINKER_OFF)
#define ASHMEM_SHRINK_WAIT (KIMAGE_TEXT_BASE + ASHMEM_SHRINK_WAIT_OFF)
#define ASHMEM_LRU_LIST (KIMAGE_TEXT_BASE + ASHMEM_LRU_LIST_OFF)
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x016dce21ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x022f2a10ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x0243eff8ULL
...
#define PAGE_SLAB_CACHE_OFF 0x18
